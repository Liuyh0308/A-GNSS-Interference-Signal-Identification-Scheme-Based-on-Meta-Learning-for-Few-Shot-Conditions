...
"""
Jamming_fusion数据集的training_alldb中的每种干扰信号下的顺序分布排列为-20db,-18db.....-10db,然后是10db,-8db,8db,-6db,6db....（依次交叉）..-2db,2db,0db;
不论是dataset_image or dataset_sequence都是如此排列training_alldb的数据
"""

## 单独的Jamming_img数据集
parser.add_argument('--train_data_dir', type=str,
                    default="./data/Jamming_Signal_Dataset/Trainning_data/dataset_images/All_dB/",
                    help='The directory containing the train image data.')
parser.add_argument('--val_data_dir', type=str,
                    default="./data/Jamming_Signal_Dataset/Test_data/dataset_images/10_dB/",
                    help='The directory containing the validation image data.')
...
## 单独的Jamming_seq列数据集
# parser.add_argument('--train_data_dir', type=str,
#                     default="./data/Jamming_Signal_Dataset/Trainning_data/dataset_sequences/All_dB/",
#                     help='The directory containing the train image data.')
# parser.add_argument('--val_data_dir', type=str,
#                     default="./data/Jamming_Signal_Dataset/Test_data/dataset_sequences/10_dB/",
#                     help='The directory containing the validation image data.')



## 多模态Jamming_fusion数据集传参
## 图片数据集传参
