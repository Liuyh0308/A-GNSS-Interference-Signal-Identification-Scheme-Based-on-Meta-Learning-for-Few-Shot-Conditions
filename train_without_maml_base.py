...
if __name__ == '__main__':
    ...
    # 数据集根目录
    train_root_dir = './data/Jamming_Signal_Dataset/Trainning_data/dataset_images/All_dB'
    val_root_dir = './data/Jamming_Signal_Dataset/Test_data/dataset_images/10_dB'
